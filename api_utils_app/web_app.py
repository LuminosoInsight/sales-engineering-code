...
def bi_tool_export():
    ...
    score_drivers, scl_match_counts, concepts, driver_fields, skt, themes = pull_lumi_data(proj, api_url, skt_limit=int(skt_limit), concept_count=int(concept_count))
    ...
    if sdot_on:
        ...
        sdot_table = create_sdot_table(score_drivers, driver_fields, date_field_info, sdot_end, int(sdot_iterations), sdot_range_type, topic_drive, root_url='', docs=docs)
